...
src_prepare() {
	...
	epatch "${FILESDIR}/openafs-1.6.5-fix-uidgid-strict-type-checks.patch"
	epatch "${FILESDIR}/openafs-cve-2014-0159.patch"
#	epatch "${FILESDIR}/openafs-cve-2014-2852.patch" Needs additonal patches from upstream to apply
	epatch_user
